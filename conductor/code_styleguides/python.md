...
- **Linting:** Run `flake8` and `mypy` on your code to catch bugs and style issues.
...
- **Line Length:** This project does not enforce a strict line length limit. Readability is prioritized over character count.
